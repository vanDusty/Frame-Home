package cn.van.mybatis.pagination.page;

import cn.van.mybatis.pagination.dialect.Dialect;
...
public class MybatisPageInterceptor implements Interceptor {
    ...
    public static final ThreadLocal<MybatisPageInterceptor.PageParam> PARAM_THREAD_LOCAL = new ThreadLocal<>();

    public MybatisPageInterceptor(Dialect dialect) {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        MybatisPageInterceptor.PageParam pageParam = PARAM_THREAD_LOCAL.get();
        //判断是否需要分页
        if (pageParam != null) {
    ...
    public static void startPage(int pageNum, int pageSize) {
        ...
        int limit = pageSize;
        MybatisPageInterceptor.PageParam pageParam = new MybatisPageInterceptor.PageParam();
