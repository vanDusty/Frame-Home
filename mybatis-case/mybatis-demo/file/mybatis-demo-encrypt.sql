DROP TABLE IF EXISTS `user_info_encrypt`;
CREATE TABLE `user_info_encrypt` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT 'Mybatis Encrypt 示例';